...
public class RTouchpadMainGui
{
	...
	private void initialize()
	{
		...
		frmRemoteTouchpadClient.setTitle("ĐỒ ÁN NHÓM 1");
		...
		tabbedPane.addTab("Chương Trình", null, panel_Main, null);
		...
		btn_StartListening = new JButton("START");
		...
		JLabel lblNewLabel_1 = new JLabel("Clients kết nối:");
		...
		list_ConnectedClients.setBackground(Color.pink);
		list_ConnectedClients.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				if (list_ConnectedClients.getSelectedIndex() != -1)
				{
					...
					int reply = JOptionPane.showConfirmDialog(null, "Bạn muốn ngắt kết nối.", "Message", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		...
		tabbedPane.addTab("Thông Báo", null, panel_Log, null);
	...
	public void setButtonStatus(boolean isListening)
	{
		if (isListening)
		{
			...
			btn_StartListening.setText("STOP");
		} else
		{
			btn_StartListening.setText("START");
		}
	}
	...
	{
		postLogText(false, "Tìm kiếm thiết bị...");
		...
		{
			e.printStackTrace();
			postLogText(true, "Không tìm thấy thiết bị: " + e.getMessage());
		...
		postLogText(false, "Phát hiện thiết bị: " + xxDeviceDescription);
